      ...
      <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center text-white" style="background-color: rgba(0, 0, 0, 0.2);">
          <div class="col-lg-8">
            ...
            <a href="../about.html" class="btn btn-lg mt-3 text-white" id="headBtn">Find Out More</a><br>
          </div>
        </div>
      </div>
    </header>
        ...
        <div class="row align-items-left justify-content-left text-left py-5">
          ...
          <!--ABOUT PARAGRAPH-->
            <div class="col-lg-8 my-3">
              ...
              <a href="../contact.php" class="btn btn-lg mt-3" id="contactBtn">Contact Me</a>
            </div>
        </div>
      </div>
    </section>
          ...
          <!--Portfolio Item-->
              ...
              <div class="col mb-4">
                  <div class="card bg-light text-center border-light shadow h-100">
                      ...
                      <div class="card-body">
                          <h3 class="card-title">A City <br>Within A Face</h3>
                          <hr class="bg-primary">
                  ...
                  <a href="../portfolio.php" class="btn btn-lg mt-3" id="portBtn">See More of my Portfolio</a>
              </div>
